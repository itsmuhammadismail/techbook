          ...
          <div className="flex flex-wrap justify-center items-center gap-8">
            <Zoom delay={1000}>
              <div className="flex flex-col items-center w-[16rem] h-[19rem]   ">
                ...
                <h2 className="text-xl mt-4 ">Farhan ALi Khan</h2>
            ...
            <Zoom delay={1500}>
              <div className="flex flex-col items-center w-[16rem] h-[19rem]   ">
                ...
                <h2 className="text-xl mt-4 ">Muhammad Hamza Arif</h2>
                <p className="text-center text-sm">Software Engineer</p>
              </div>
            </Zoom>
            <Zoom delay={2500}>
              <div className="flex flex-col items-center w-[16rem] h-[19rem]   ">
                ...
                <h2 className="text-xl mt-4 ">Hafiz Hamza Farooq</h2>
                <p className="text-center text-sm">Senior PHP Developer</p>
              </div>
            </Zoom>
          </div>
        </div>
