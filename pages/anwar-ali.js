          ...
          <div className="flex flex-wrap justify-center items-center gap-8">
            <Zoom delay={1000}>
              <div className="flex flex-col items-center w-[16rem] h-[19rem]   ">
                ...
                <h2 className="text-xl mt-4 ">Aashiq Rasheed</h2>
            ...
            <Zoom delay={1500}>
              <div className="flex flex-col items-center w-[16rem] h-[19rem]   ">
                ...
                <h2 className="text-xl mt-4 ">Muddasir Hussain</h2>
                <p className="text-center text-sm">Junior Oracle Developer</p>
              </div>
            </Zoom>
            <Zoom delay={2500}>
              <div className="flex flex-col items-center w-[16rem] h-[19rem]   ">
                ...
                <h2 className="text-xl mt-4 ">Saad Ahmed Khan</h2>
