          ...
          <div className="flex flex-wrap justify-center items-center gap-8">
            <Zoom delay={1000}>
              <div className="flex flex-col items-center w-[16rem] h-[19rem]   ">
                ...
                <h2 className="text-xl mt-4 ">Umar Aslam</h2>
            ...
            <Zoom delay={1500}>
              <div className="flex flex-col items-center w-[16rem] h-[19rem]   ">
                ...
                <h2 className="text-xl mt-4 ">Shah Wajahat Ejaz</h2>
                <p className="text-center text-sm">Jr Software Engineer</p>
              </div>
            </Zoom>
            <Zoom delay={2500}>
              <div className="flex flex-col items-center w-[16rem] h-[19rem]   ">
                ...
                <h2 className="text-xl mt-4 ">Fahad Hasan Khan</h2>
                <p className="text-center text-sm">Jr Web Developer</p>
              </div>
            </Zoom>
            <Zoom delay={2500}>
              <div className="flex flex-col items-center w-[16rem] h-[19rem]   ">
                ...
                <h2 className="text-xl mt-4 ">M Shoaib Noorullah</h2>
                <p className="text-center text-sm">Senior React Developer</p>
              </div>
            </Zoom>
          </div>
        </div>
