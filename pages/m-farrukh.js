          ...
          <div className="flex flex-wrap justify-center items-center gap-8">
            <Zoom delay={1000}>
              <div className="flex flex-col items-center w-[16rem] h-[19rem]   ">
                ...
                <h2 className="text-xl mt-4 ">Basil Khalid</h2>
                <p className="text-center text-sm">Database Administrator</p>
              </div>
            </Zoom>
            <Zoom delay={1500}>
              <div className="flex flex-col items-center w-[16rem] h-[19rem]   ">
                ...
                <h2 className="text-xl mt-4 ">Muhammad Shahzad</h2>
                <p className="text-center text-sm">Database Administrator</p>
              </div>
            </Zoom>
            <Zoom delay={2500}>
              <div className="flex flex-col items-center w-[16rem] h-[19rem]   ">
                ...
                <h2 className="text-xl mt-4 ">Ijlal Masood Khan</h2>
                <p className="text-center text-sm">Junior DBA</p>
              </div>
            </Zoom>
            <Zoom delay={3000}>
              <div className="flex flex-col items-center w-[16rem] h-[19rem]   ">
                ...
                <h2 className="text-xl mt-4 ">Hassan Shahid</h2>
                <p className="text-center text-sm">Junior DBA</p>
              </div>
            </Zoom>
          </div>
