              ...
              <div className="flex flex-col">
                ...
                <div className="flex">
                  <p className="tracking-wide text-sm mt-6 max-w-[56rem] text-[#707070] text-justify sm:text-left">
                    ...
                    development that involves all functional groups at all
                    levels within TCS. It provides direction for successfully
                    managing the development of products. The process consists
                    of basic elements: New Initiative Request, Product
                    ...
                    <ol className="list-decimal mt-2 ml-[1.3rem] ">
                      <li className="pl-2">
                        {" "}
                        Production support team will check UX or glitches/bugs
                        and forward to the development team if there is any
                        critical issues or get technical details if required.{" "}
                      </li>
                      <li className="pl-2">
                        {" "}
                        If there is any change request during issue fixes then
                        PM is involved and NIR is submitted.{" "}
                      </li>
                      <li className="pl-2">
                        {" "}
          ...
          >
            <>
              <div className="flex flex-col">
                <div className=" ho sop text-center sm:text-left">SOP</div>
                <div className="flex">
                  <p className="text-sm tracking-wide mt-6 max-w-[56rem] text-[#707070] text-justify sm:text-left">
                    This process is an integrated flexible approach to product
                    development that involves all functional groups at all
                    levels within TCS. Tt provides direction for successfully
                    managing the development of products. The process consists
                    of basic elements: New initiative Request, Product
                    Development, and Production Support.
                  </p>
                ...
                <p className="text-sm tracking-wide mt-6 max-w-[56rem] text-[#707070] text-justify sm:text-left">
                  ...
                  <ul className="list-disc mt-2 ml-[1.2rem] ">
                    <li className="pl-2">
                      ...
                      Maintenance, Optimization & backups.{" "}
                    </li>
                    <li className="pl-2">
                      {" "}
                    ...
                    <li className="pl-2">
                      Database Compression & Partitioning.
                    </li>
                    <li className="pl-2">
                      Database Patch Set Updates, Jobs Scheduling, DMLs
                      executions & Json Packages Installation.{" "}
                    </li>
                    <li className="pl-2">
                      Database Migrations & Heterogenous DB Links.{" "}
                    </li>
                    <li className="pl-2">
                      Data guards Configuration & Encryption Wallets
                      installation{" "}
                    </li>
                ...
                <p className="text-sm tracking-wide mt-6 max-w-[56rem] text-[#707070] text-justify sm:text-left">
                  ...
                  <ul className="list-disc mt-2 ml-[1.2rem]">
                    ...
                    <li className="pl-2">
                      ...
                      applications and modules for smooth transition of
                      financial data & Smooth running of all oracle financials
                      and SCM modules.{" "}
                    </li>
                    <li className="pl-2">
              ...
              <div className="flex flex-col">
                ...
                <div className="flex">
                  <p className="text-sm tracking-wide mt-6 max-w-[56rem] text-[#707070] text-justify sm:text-left">
                    ...
                    portal and its defined procedures. All enhancements or
                    changes will be taking care through PMO team and followed by
                    NIR procedure.
                    <ul className="list-disc mt-2 ml-[1.2rem]">
                      <li className="pl-2">
                        {" "}
          ...
          >
            <div className="flex flex-col">
              ...
              <div className="flex max-w-[56rem]">
                <ul className="text-sm list-disc mt-4 ml-[1.2rem] text-[#707070] text-justify sm:text-left">
                  <li className="pl-2">
                  ...
                  <li className="pl-2">
                    ...
                    involves understanding stakeholder needs, presenting data,
                    and designing processes to support the needs of all teams at
                    DO who require the use of Hardware servers
                  </li>
                  <li className="pl-2">
          ...
          >
            <>
              <div className="flex flex-col">
                ...
                <div className="flex">
                  <p className="text-sm tracking-wide mt-6 max-w-[56rem] text-[#707070] text-justify sm:text-left">
                    Team will follow standard NIR process for any new
                    development around the ERP footprints. For any support
                    ...
                    <ul className="list-disc mt-2 ml-[1.2rem] ">
                      ...
                      <li className="pl-2">
                        Develop new reports upon existing ERP modules required
                        by business.
                      </li>
                      <li className="pl-2">
                        Troubleshoot and efficient resolution for the issues
              ...
              <div className="flex">
                <p className="text-sm tracking-wide mt-6 max-w-[56rem] text-[#707070] text-justify sm:text-left">
                  ...
                  <ul className="list-disc mt-2 ml-[1.2rem]">
                    ...
                    <li className="pl-2">
                      Provide remote support using tools.
                    </li>
                    <li className="pl-2">
                    ...
                    <li className="pl-2">
                      Record keeping of devices area wise.
                    </li>
                    <li className="pl-2">
                    ...
                    <li className="pl-2">
                      Vendor management with a liaison of Admin procurement
                      team, secure equipment after resigning or closingbusiness
                      unit/project.
                    </li>
                    <li className="pl-2">
